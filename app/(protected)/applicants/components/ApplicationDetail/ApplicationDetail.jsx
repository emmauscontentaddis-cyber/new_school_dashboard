...
import { scheduleInterview, completeInterview, getApplicationActivities, logActivity, sendOfferLetter, completeEnrollment } from '@/services/applications'
...
export default function ApplicationDetail({ applicationId, onClose }) {
  ...
  useEffect(() => {
    ...
    if (selectedApplication) {
      ...
      // Clear state when no application is selected
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6" style={{ minHeight: 0, maxHeight: 'calc(95vh - 140px)' }}>
          ...
          {activeTab === 'screening' && (
            ...
            <ScreeningCheck
              ...
              onFlag={handleScreeningComplete}
                    ...
                    <>
                      ...
                      <div className="flex gap-2">
                        ...
                        {(() => {
                          ...
                          const calendarLinks = getInterviewCalendarLinks(app, { interview_date: app.interview_date, interview_location: app.interview_location })
